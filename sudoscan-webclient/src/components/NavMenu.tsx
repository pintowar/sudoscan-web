                ...
                <div className="relative flex items-center justify-between h-16">       
                    <div className="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start font-mono">
                        <div className="flex-shrink-0 flex items-center">
                            <svg x="0px" y="0px" viewBox="0 0 445.049 445.049" className="hidden lg:block h-8 w-auto fill-current text-white">
                                <path d="M56.507,73.548c-3.393-3.632-3.2-9.327,0.433-12.72l26.938-25.166c2.619-2.447,6.44-3.106,9.729-1.679
